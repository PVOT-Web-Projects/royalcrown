        ...
        {slides.map((slide, index) => (
          <div key={index} className="itemSlider">
            <div className="contentSlider">
              ...
              <Link href={slide.urlLink} className="yello_btn">
